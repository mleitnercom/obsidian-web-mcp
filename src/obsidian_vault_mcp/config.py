...
# fastembed only: embed with this many worker processes of one thread each instead of one
# multi-threaded process. 0 or 1 is off. Meant for the reindex job, not for the server.
SEMANTIC_EMBED_PARALLEL = _env_int("VAULT_SEMANTIC_EMBED_PARALLEL", 0)
